...
export default function MainSection() {
    return (<section id="home" className="flex flex-col-reverse items-center justify-center gap-10 scroll-mt-28 lg:flex-row lg:gap-5">
        <div className="flex w-full flex-col items-center justify-center gap-5">
            <h1 className='text-glow text-center text-4xl font-bold text-(--violet-color) sm:text-5xl lg:text-7xl'>Kerolos Fayez</h1>
            ...
            <p className='w-full max-w-2xl text-center text-base text-(--white-color) sm:text-lg'>Frontend Developer with two years of self-directed experience building modern, responsive, and user-centered web interfaces. Passionate about transforming ideas into polished, high-quality digital experiences through strong problem-solving, attention to detail, and collaborative teamwork.</p>
        </div>
